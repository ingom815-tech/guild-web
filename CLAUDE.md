...
- 배포된 프론트 = **v=89** (커밋 표의 마지막 행). 로컬 미푸시 작업 없음.
...
| (최신) | 규정 탭 결사 회의(2026-09-22) 반영: 3단 브로치 확정(캐릭터당 1회·최대 5개, 전투력 상위 순, 우선 조건 ①결사증표 ②태양석 ③전단계 풀강, 전승 간 전투력 차이 미포함) · 영웅 재해 확정(기여점수 순) · 신규 전퀴 지원 개정(라인 4종, 쟁 참여도 우선, 희망자 조사→운영진 회의, PVE/PVP 각 1개 시즌당) · 쟁 참여도 우수 보상 신설(최대 10명, 선택지 4종) · 개정 이력 줄 — 별도로 item_master에 A1/B6 라인 전설 아퀴룬 SQL 등록(드랍 매칭용, C1은 확인 안내) — **현재 배포 버전 (v=89)** |
