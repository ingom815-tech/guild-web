-- 0025: 쟁 지표에 유니/결던 포함 (사용자 승인 정책 변경, 2026-08-12)
--
-- 일정(점수·일정참여율)은 기존 그대로 5종(본토/시틈/유니/결던/별봉) — 변경 없음.
-- 쟁 지표(jaeng_count/jaeng_rate/시간대)만 '쟁(레거시 긴급)' 외에 '유니'와 '결던'도 집계.
-- 즉 유니/결던 세션은 일정과 쟁 양쪽에 모두 반영된다.
